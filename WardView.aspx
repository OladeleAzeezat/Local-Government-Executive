<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="WardView.aspx.cs" Inherits="Default2" EnableEventValidation="false" %>
        ...
        <div class="row" runat="server" id="panel0" visible="true">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <h6 class="text-center text-primary">NOTE: WARD PAGE 
                    <br />
                    <small>Select the dropdown to view Ward Executives</small><br />
                    <a href="WardView.aspx">Refresh</a>
                </h6>
