...
public partial class Default2 : System.Web.UI.Page
{
    ...
    protected void GvbindAll()
    {
        ...
        {
            scon.Open();
            SqlCommand cmd = new SqlCommand("Select pu as 'Polling Unit', pos as 'Position', name as 'Name', num as 'Number', card as 'Voter Card' from PuExcoTb where lg=@lg", scon);
    ...
    protected void GvbindPu()
    {
        ...
        {
            scon.Open();
            SqlCommand cmd = new SqlCommand("Select pu as 'Polling Unit', pos as 'Position', name as 'Name', num as 'Number', card as 'Voter Card' from PuExcoTb where ward = @ward AND pu=@pu", scon);
