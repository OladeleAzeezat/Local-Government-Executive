<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="CanView.aspx.cs" Inherits="Default2" EnableEventValidation="false" %>
        ...
        <div class="row" runat="server" id="panel0" visible="true">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <h6 class="text-center text-primary">NOTE: CANVASSER PAGE 
                    <br />
                    <small>Select the dropdown to view Canvassers</small><br />
                    <a href="CanView.aspx">Refresh</a>
                </h6>
                         ...
                         <div class="row">                            
                            <div class="form-group col-lg-4 col-md-12 col-sm-12">
                                <label for="credit2">Local Government:
                                    <asp:RequiredFieldValidator ControlToValidate="LgList" ID="RequiredFieldValidator1" ErrorMessage="*" runat="server" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                </label>
                                <asp:TextBox ID="LgList" runat="server" AutoPostBack="True" onchange="GetWard()" CssClass="form-control form-control-rounded txtInput" readonly="true"></asp:TextBox>
                                </div>
                            <div class="form-group col-lg-4 col-md-12 col-sm-12">
