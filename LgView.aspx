<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="LgView.aspx.cs" Inherits="Default2" EnableEventValidation="false" %>
        ...
        <div class="row" runat="server" id="panel0" visible="true">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <h6 class="text-center text-primary">NOTE: LOCAL GOVERNMENT PAGE
                    <br />
                    <small>Select the dropdown to view Local Government</small><br />
                    <a href="LgView.aspx">Refresh</a>
                </h6>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-12 col-lg-12">
                                ...
                                <asp:GridView ID="GridView1" runat="server" CssClass="dynamic-table table  table-striped table-bordered table-hover mt-2" >
                                    <Columns>
