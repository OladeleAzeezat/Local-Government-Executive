...
public partial class Default2 : System.Web.UI.Page
{
    ...
    protected void GvbindAll()
    {
        ...
        {
            scon.Open();
            SqlCommand cmd = new SqlCommand("Select lg as 'Local Govt', ward as 'Ward', pos as 'Position', name as 'Name', num as 'Number', card as 'Voter Card' from WardExcoTb where lg=@lg", scon);
    ...
    protected void GvbindWard()
    {
        ...
        {
            scon.Open();
            SqlCommand cmd = new SqlCommand("Select lg as 'Local Govt', ward as 'Ward', pos as 'Position', name as 'Name', num as 'Number', card as 'Voter Card' from WardExcoTb where ward=@ward", scon);
