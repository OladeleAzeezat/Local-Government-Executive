<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="CanSub.aspx.cs" Inherits="Default2"  EnableEventValidation="false" %>
    ...
    <div class="main-content">
        ...
        <div class="row" runat="server" id="panel0" visible="true">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <h6 class="text-center text-primary">NOTE: CANVASSER PAGE 
                    <br />
                ...
                <div class="card mb-5">
                    <div class="card-body">
                        <div class="row">                            
                            ...
                            <div class="form-group col-lg-3 col-md-12 col-sm-12">
                                <label for="credit2">Submitted By:
                                    <asp:RequiredFieldValidator ControlToValidate="PosList" ID="RequiredFieldValidator3" ErrorMessage="*" runat="server" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                </label>
                                 <asp:DropDownList ID="PosList" runat="server" required="true" CssClass="form-control form-control-rounded txtInput">
                       ...
                       <div class="row">
                            ...
                            <div class="col-lg-3 col-md-12 col-sm-12">
                                ...
                                <asp:TextBox ID="txtNumber" runat="server" class="form-control form-control-rounded" type="text" placeholder="Phone Number"></asp:TextBox>
                            </div>
                           <div class="col-lg-3 col-md-12 col-sm-12">
                                <label for="firstName1">Age:</label>
                                <asp:TextBox ID="txtAge" runat="server" class="form-control form-control-rounded" type="text" placeholder="Phone Number"></asp:TextBox>
                            </div>
                            <div class="col-lg-3 col-md-12 col-sm-12">
                                <label for="firstName1">Voters Card Number:</label>
                                <asp:TextBox ID="txtCard" runat="server" class="form-control form-control-rounded" type="text" placeholder="Voters Card Number"></asp:TextBox>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12">
